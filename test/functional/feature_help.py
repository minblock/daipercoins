...
"""Verify that starting daipercoins with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start daipercoins with -h for help text")
        ...
        self.log.info("Start daipercoins with -version for version information")
        ...
        self.log.info("Start daipercoinsd with -fakearg to make sure it does not start")
