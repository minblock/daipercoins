# Support for Output Descriptors in Daipercoins Core

Since Daipercoins Core v0.17, there is support for Output Descriptors. This is a
...
on Daipercoins's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Daipercoins Core wallets, a convenience function `combo` is
