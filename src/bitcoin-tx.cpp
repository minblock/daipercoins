...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " daipercoins-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  daipercoins-tx [options] <hex-tx> [commands]  Update hex-encoded daipercoins transaction\n" +
            "or:     daipercoins-tx [options] -create [commands]   Create hex-encoded daipercoins transaction\n" +
            "\n";
